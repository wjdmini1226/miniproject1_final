...
public static String getPaging2(
		          String pageURL,
		          int nowPage, 
		          int rowTotal,
		          int blockList, 
...
//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if(isPrevPage){
			sb.append("<li><a href='list.do?page="+ (startPage-1) +"'>◀</a></li>");
		}
		else
...
//-----그룹페이지처리 다음 ----------------------------------------------------------------------------------------------
		if(isNextPage){
			sb.append("<li><a href='list.do?page="+ (endPage+1) +"'>▶</a></li>");
		}
		else
		    sb.append("<li><a href='#'>▶</a></li>");
//---------------------------------------------------------------------------------------------------------------------	    
    ...
    public static String getPaging3(String pageURL,String searchFilter, int nowPage, int rowTotal,int blockList, int blockPage){
...
//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if(isPrevPage){
			sb.append(String.format("<li><a href='list.do?page=%d&%s'>◀</a></li>", (startPage-1), searchFilter));
		}
		else
		    sb.append("<li><a href='#'>◀</a></li>");
...
//------페이지 목록 출력 -------------------------------------------------------------------------------------------------
		for(int i=startPage; i<= endPage ;i++){
			...
			if(i == nowPage){ //현재 있는 페이지
				...
				sb.append(String.format("<li><a href='list.do?page=%d&%s'>%d</a></li>",i,searchFilter,i));
			}
		}// end for
...
//-----그룹페이지처리 다음 ----------------------------------------------------------------------------------------------
		if(isNextPage){
			...
			sb.append(String.format("<li><a href='list.do?page=%d&%s'>▶</a></li>", (endPage+1), searchFilter));
		}
		else
		    sb.append("<li><a href='#'>▶</a></li>");
//---------------------------------------------------------------------------------------------------------------------	    
